...
public class C05_DriverManageMethodlari {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(15)); // Her classta olması gerekir bu 4 lu
        ...
        System.out.println("Degisen yeni konum konumu : " + driver.manage().window().getPosition());
